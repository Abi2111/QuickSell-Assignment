...
import { fetchTickets, selectGroupedTickets } from './redux/ticketsSlices';
...
function App() {
  ...
  const groupedTickets = useSelector(state =>
    selectGroupedTickets(state, grouping, ordering)
  );
          ...
          return group === 'Todo' ? (
            <div key={group}>
              <div className="todo-header">
                <div className="todo-info">
                  ...
                  <h2> {group} </h2> <h3>{groupedTickets[group].length}</h3>
                </div>
            ...
            <div key={group}>
              <div className="todo-header">
                <div className="todo-info">
                  <span>
                    {groupedTickets[group][0].priority === 0 ? (
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                  ...
                  <h3>{groupedTickets[group].length}</h3>
                </div>
                <div className="todo-action">
                  <span>
                    <svg
